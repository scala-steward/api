...
case class CEDICTDefinition(subdefinitions: Array[String], simplified: String, traditional: String, pinyin: String)
...
object CEDICT {
  ...
  private def parseLine(line: String): CEDICTDefinition = {
    ...
    CEDICTDefinition(traditional=characterSection(0), simplified=characterSection(1), pinyin=cutAtPinyinBack(0), subdefinitions=definitionSection.split('/'))
  }
}
